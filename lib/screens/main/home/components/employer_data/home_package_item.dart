...
class HomePackageItem extends StatefulWidget {
  const HomePackageItem({
    super.key,
  ...
  @override
  State<HomePackageItem> createState() => _HomePackageItemState();
}

class _HomePackageItemState extends State<HomePackageItem> {
