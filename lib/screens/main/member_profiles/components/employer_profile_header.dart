...
class EmployerProfileHeader extends StatefulWidget {
  ...
  @override
  State<EmployerProfileHeader> createState() => _MemberProfileHeaderState();
}

class _MemberProfileHeaderState extends State<EmployerProfileHeader> {
