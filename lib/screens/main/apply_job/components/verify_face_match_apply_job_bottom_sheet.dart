...
import 'package:wazafak_app/screens/main/apply_job/apply_job_controller.dart';
import 'package:wazafak_app/utils/res/AppContextExtension.dart';
import 'package:wazafak_app/utils/res/Resources.dart';
import 'package:wazafak_app/utils/utils.dart';

class VerifyFaceMatchApplyJobBottomSheet extends StatefulWidget {
  const VerifyFaceMatchApplyJobBottomSheet({super.key});

  @override
  State<VerifyFaceMatchApplyJobBottomSheet> createState() =>
      _VerifyFaceMatchApplyJobBottomSheetState();
}

class _VerifyFaceMatchApplyJobBottomSheetState
    extends State<VerifyFaceMatchApplyJobBottomSheet> {
  @override
  void initState() {
    super.initState();
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PrimaryText(
                    text:
                        'Please use your camera to capture a clear photo of your face to proceed with applying for this job',
                    fontSize: 14,
                ...
                return Opacity(
                  ...
                  child: PrimaryButton(
                    title: Resources
                        ...
                        .verifyAndApply,
                    onPressed: hasImage
                        ? controller.verifyFaceMatchAndSubmit
                        : () {
