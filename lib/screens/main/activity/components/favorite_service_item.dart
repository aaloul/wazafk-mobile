...
class FavoriteServiceItem extends StatefulWidget {
  ...
  @override
  State<FavoriteServiceItem> createState() => _FavoriteServiceItemState();
}

class _FavoriteServiceItemState extends State<FavoriteServiceItem> {
